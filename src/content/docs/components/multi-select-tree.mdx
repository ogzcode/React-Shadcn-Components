...
<div className="mt-4 text-sm text-red-500 p-2 rounded-md bg-red-50">
  <p><strong>Warning:</strong> Works for only one level of children. Does not work for multiple levels of children.</p>
</div>
<br/>
...
<div className="mt-4 text-sm text-red-500 p-2 rounded-md bg-red-50">
  <p><strong>Warning:</strong> The checkbox may not work due to Astro.</p>
</div>
