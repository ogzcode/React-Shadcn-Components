...
<div className="mt-4 text-xs text-red-500">
  <p><strong>Uyarı:</strong> Select All için checkbox Astro'dan dolayı çalışmıyor olabilir.</p>
</div>
